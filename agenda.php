...
<?php include_once("analyticstracking.php") ?>
    ...
    <div style="background-image:url(img/grid.png); background-repeat:repeat;">
		...
		<div class="container">
			...
			<div class="section">
                <h1 class="section-title title">Agenda</h1>
				<div class="row">
							...
							<div class="left-content">
                               ...
                               <div class="section listing-news">
                        		<?
                                    ...
                                    $datatrans = explode ("-", $linha["data_agenda"]); 
                                    $data = "$datatrans[2]/$datatrans[1]/$datatrans[0]";
                                ?>
								<div class="post">
									<div class="entry-header">
										<div class="entry-thumbnail">
                                        <a href="verAgenda.php?agenda=<?=$linha["id_agenda"];?>&localidade=<?=$localidade;?>">
											<img class="img-responsive" src="conteudo/img/<?=$linha["imagem_agenda"];?>" />
										</a>
                                        </div>
									</div>
									<div class="post-content">								
										...
										<h2 class="entry-title">
											<a href="verAgenda.php?agenda=<?=$linha["id_agenda"];?>&localidade=<?=$localidade;?>"><?=$linha["titulo_agenda"];?></a>
										</h2>
										<div class="entry-content">
											<p><?=substr($linha["desc_agenda"],0,150); ?>...</p>
										</div>
									</div>
								</div><!--/post-->
                                <? } ?>
