...
<title>Guia Comercial | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?></title>
<meta name="dc.title" content="Guia Comercial | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<link rel="image_src" type="image/jpeg" title="Guia Comercial | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" href="conteudo/img/<?=$row_busca_interfaceweb["open_graph"];?>"/>
...
<meta content="Guia Comercial | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" property="twitter:title">
<meta property="og:title" content="Guia Comercial | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<?php include_once("analyticstracking.php") ?>
    ...
    <div style="background-image:url(img/grid.png); background-repeat:repeat;">
		...
		<div class="container">
			...
			<div class="section">
                <h1 class="section-title title">Guia Comercial</h1>
				<div class="row">
						...
						<div id="site-content" class="site-content">
							...
							<div class="left-content">
                               ...
                               <div class="section listing-news">
                        		<?
                                    $sql = "SELECT * FROM negocio, categoria_negocio WHERE negocio.id_categoria_negocio = categoria_negocio.id_categoria_negocio AND status_negocio = 1 AND (negocio.id_localidade = '$localidade' OR negocio.id_localidade = 0) ORDER BY id_negocio DESC";
									...
									<div class="post-content">								
										<div class="entry-meta">
											<ul class="list-inline">
												<li class="publish-date"><a href="#"><i class="fa fa-tag"></i> <?=$linha["titulo_categoria_negocio"];?> </a></li>
											</ul>
										</div>
										...
										<div class="entry-content">
											<p><?=substr($linha["desc_negocio"],0,140); ?>...</p>
										</div>
									</div>
								</div><!--/post-->
                                <? } ?>
