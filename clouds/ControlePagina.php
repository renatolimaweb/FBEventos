...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "controle")) {
  ...
  $insertSQL = sprintf("INSERT INTO pagina (id_localidade, titulo_pagina, desc_pagina, tags_pagina, texto_pagina, imagem_pagina, posicao_pagina, status_pagina) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['posicao_pagina'],"int"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "controle")) {
  ...
  if ($arquivo["name"] != "") {
	 ...
	 $apagar = "../conteudo/img/".$_POST["imagem_pagina_original"];
	 if (is_file($apagar)) {
	 	unlink($apagar);
	 }	
  } else {
  ...
  $updateSQL = sprintf("UPDATE pagina SET id_localidade=%s, titulo_pagina=%s, desc_pagina=%s, tags_pagina=%s, texto_pagina=%s, imagem_pagina=%s, posicao_pagina=%s, status_pagina=%s WHERE id_pagina=%s",
                       GetSQLValueString($_POST['id_localidade'],"int"),
                       GetSQLValueString($_POST['titulo_pagina'],"text"),
					   GetSQLValueString($_POST['desc_pagina'],"text"),
					   GetSQLValueString($_POST['tags_pagina'],"text"),
...
<html class="fixed">
	<head>
		...
		<title>Controle de Páginas | FestasBrasil | Clouds | Sistema Gerenciador</title>
                    ...
                    ?> 
                     ...
                     <? } ?>
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="titulo_pagina" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_busca_dados["titulo_pagina"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<textarea id="desc_pagina" name="desc_pagina" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_busca_dados["desc_pagina"];?></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="tags_pagina" id="tags-input" data-role="tagsinput" data-tag-class="label label-primary" class="form-control" value="<?=$row_busca_dados["tags_pagina"];?>" />
			  	     ...
			  	     ?>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <img class="img-responsive" src="../conteudo/img/<?=$row_busca_dados["imagem_pagina"];?>" border="0" />
											 <? } ?>
                                             </div>
                                            </div>
											<div class="form-group">
													...
													<div class="fileupload fileupload-new" data-provides="fileupload">
														<div class="input-append">
															...
															<span class="btn btn-default btn-file">
																...
																<input id="imagem_pagina" name="imagem_pagina" type="file"/>
															</span>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<select class="form-control mb-md">
														<option value="1" <?php if (!(strcmp(1, $row_busca_dados['posicao_pagina']))) {echo "selected=\"selected\"";} ?>>Menu</option>
                                                        <option value="2" <?php if (!(strcmp(2, $row_busca_dados['posicao_pagina']))) {echo "selected=\"selected\"";} ?>>Internas</option>
													</select>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_pagina" name="status_pagina" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_busca_dados['status_pagina']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group">
