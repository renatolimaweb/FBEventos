...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "controle")) {
  ...
  $insertSQL = sprintf("INSERT INTO categoria_noticia (titulo_categoria_noticia, status_categoria_noticia) VALUES (%s, %s)",
					   GetSQLValueString($_POST['titulo_categoria_noticia'],"text"),
					   GetSQLValueString($_POST['status_categoria_noticia'],"int"));
  ...
  $Result1 = mysql_query($insertSQL, $conexao) or die(mysql_error());
	...
	<SCRIPT language="JavaScript">
		...
		location.href="ConsultaCategoriaNoticia.php";
	</script>
	<?
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "controle")) {
  ...
  $updateSQL = sprintf("UPDATE categoria_noticia SET titulo_categoria_noticia=%s, status_categoria_noticia=%s WHERE id_categoria_noticia=%s",
                       GetSQLValueString($_POST['titulo_categoria_noticia'],"text"),
					   GetSQLValueString($_POST['status_categoria_noticia'],"int"),
...
if ($colname_busca_dados) {
	$query_busca_dados = sprintf("SELECT * FROM categoria_noticia WHERE id_categoria_noticia = %s", GetSQLValueString($colname_busca_dados, "int"));
...
<html class="fixed">
	...
	<body>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Controle de Categorias de Notícias</h2>
					</header>
					...
					<form method="post" name="controle" class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">  
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="titulo_categoria_noticia" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_busca_dados["titulo_categoria_noticia"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_categoria_noticia" name="status_categoria_noticia" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_busca_dados['status_categoria_noticia']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group">
      ...
      <input name="id_categoria_noticia" type="hidden" id="id_categoria_noticia" value="<?=$row_busca_dados["id_categoria_noticia"];?>" />
										</form>
									</div>
					<!-- end: page -->
				</section>
