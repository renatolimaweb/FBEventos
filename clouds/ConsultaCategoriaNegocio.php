			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <section class="panel">
						<div class="panel-body" style="padding-bottom:0;">
							<div class="input-group mb-md">
                             <a href="ControleCategoriaNegocio.php?tp=<?=$tipo_conteudo;?>"><span class="btn btn-lg btn-success"><i class="fa fa-check"></i> Cadastrar</span></a>
							</div>
						</div>
					</section>
				...
				if ($_REQUEST["Consulta"] != "") {
					$descpesquisa = $_REQUEST['pesquisa'];
						$sql = "SELECT * FROM categoria_negocio WHERE (titulo_categoria_negocio like '%$descpesquisa%') ORDER BY id_categoria_negocio DESC";
				} else { 
				    
					if ($_REQUEST['Del'] == "del") {
						$codigo = $_REQUEST['codigo'];
						$sql = "DELETE FROM categoria_negocio WHERE id_categoria_negocio = '$codigo'";
						$resultado = mysql_query($sql) or die ("N&atilde;o foi poss&iacute;vel realizar a consulta ao banco de dados");
					}
						$sql = "SELECT * FROM categoria_negocio ORDER BY id_categoria_negocio DESC";
				}
				...
				$codigo 			= $linha["id_categoria_negocio"];
				$titulo	        	= $linha["titulo_categoria_negocio"];
				$status             = $linha["status_categoria_negocio"];
				...
				?>
                             <section class="panel">
                                    ...
                                    <div class="col-md-12 pt-sm pb-sm">
                                        <p class="pull-right">
                                         <a href="ControleCategoriaNegocio.php?cod=<?=$codigo;?>" title="Editar"><span class="btn btn-warning"><i class="fa fa-pencil-square"></i></span></a>
                                         <a href="ConsultaCategoriaNegocio.php?Del=del&amp;codigo=<?=$codigo?>" onclick="return confirm('Deseja excluir ?')" title="Excluir"><span class="btn btn-danger"><i class="fa fa-trash-o"></i></span></a>
                                        </p>
