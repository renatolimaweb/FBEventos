...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "controle")) {
  ...
  $insertSQL = sprintf("INSERT INTO categoria_evento (titulo_categoria_evento, status_categoria_evento) VALUES (%s, %s)",
					   GetSQLValueString($_POST['titulo_categoria_evento'],"text"),
					   GetSQLValueString($_POST['status_categoria_evento'],"int"));
  ...
  $Result1 = mysql_query($insertSQL, $conexao) or die(mysql_error());
	...
	<SCRIPT language="JavaScript">
		...
		location.href="ConsultaCategoriaEvento.php";
	</script>
	<?
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "controle")) {
  ...
  $updateSQL = sprintf("UPDATE categoria_evento SET titulo_categoria_evento=%s, status_categoria_evento=%s WHERE id_categoria_evento=%s",
                       GetSQLValueString($_POST['titulo_categoria_evento'],"text"),
					   GetSQLValueString($_POST['status_categoria_evento'],"int"),
...
if ($colname_busca_dados) {
	$query_busca_dados = sprintf("SELECT * FROM categoria_evento WHERE id_categoria_evento = %s", GetSQLValueString($colname_busca_dados, "int"));
...
<html class="fixed">
	<head>
		...
		<title>FestasBrasil | Controle de Categorias de Eventos | Clouds | Sistema Gerenciador</title>
	...
	<body>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Controle de Categorias de Eventos</h2>
					</header>
					...
					<form method="post" name="controle" class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">  
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="titulo_categoria_evento" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_busca_dados["titulo_categoria_evento"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_categoria_evento" name="status_categoria_evento" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_busca_dados['status_categoria_evento']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group">
      ...
      <input name="id_categoria_evento" type="hidden" id="id_categoria_evento" value="<?=$row_busca_dados["id_categoria_evento"];?>" />
										</form>
									</div>
					<!-- end: page -->
				</section>
