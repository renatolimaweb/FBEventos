...
$query_busca_categoriaNoticia = "SELECT * FROM noticia WHERE (id_localidade = $localidade OR id_localidade = 0) AND id_categoria_noticia = $categoria ORDER BY data_noticia DESC, id_noticia DESC";
$busca_categoriaNoticia = mysql_query($query_busca_categoriaNoticia, $conexao) or die(mysql_error());
$row_busca_categoriaNoticia = mysql_fetch_assoc($busca_categoriaNoticia);
$totalRows_busca_categoriaNoticia = mysql_num_rows($busca_categoriaNoticia);
...
<title><?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?> | Notícias | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?></title>
<meta name="dc.title" content="<?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?> | Notícias | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<link rel="image_src" type="image/jpeg" title="<?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?> | Notícias | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" href="conteudo/img/<?=$row_busca_interfaceweb["open_graph"];?>"/>
...
<meta content="<?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?> | Notícias | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" property="twitter:title">
<meta property="og:title" content="<?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?> | Notícias | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<?php include_once("analyticstracking.php") ?>
    ...
    <div style="background-image:url(img/grid.png); background-repeat:repeat;">
		...
		<div class="container">
			...
			<div class="section">
                <h1 class="section-title title"><?=$row_busca_categoriaNoticia["titulo_categoria_noticia"];?></h1>
				<div class="row">
						...
						<div id="site-content" class="site-content">
							...
							<div class="left-content">
                               ...
                               <div class="section listing-news">
                        		<?
                                    $sql = "SELECT * FROM noticia WHERE (id_localidade = $localidade OR id_localidade = 0) AND id_categoria_noticia = $categoria ORDER BY data_noticia DESC, id_noticia DESC";
								...
								<div class="post">
									...
									<div class="post-content">								
										...
										<div class="entry-content">
											<p><?=substr($linha["desc_noticia"],0,150); ?>...</p>
										</div>
									</div>
								</div><!--/post-->
                                <? } ?>
