...
<title>Coberturas | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?></title>
<meta name="dc.title" content="Coberturas | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<link rel="image_src" type="image/jpeg" title="Coberturas | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" href="conteudo/img/<?=$row_busca_interfaceweb["open_graph"];?>"/>
...
<meta content="Coberturas | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>" property="twitter:title">
<meta property="og:title" content="Coberturas | <?=$row_busca_config["titulo_config"];?> | <?=$row_busca_localidade["titulo_localidade"];?> - <?=$row_busca_localidade["titulo_estado"];?>"/>
...
<?php include_once("analyticstracking.php") ?>
    ...
    <div style="background-image:url(img/grid.png); background-repeat:repeat;">
        ...
        <!-- publicidade topo internas -->
			...
			<div class="section">
                <h1 class="section-title title">Galerias de Fotos</h1>
				<div class="row">
					...
					<div class="col-sm-9">
						<div id="site-content" class="site-content">
							...
							<div class="left-content">
                               ...
                               <?
                                    $sql = "SELECT * FROM evento WHERE id_localidade = $localidade OR id_localidade = 0 ORDER BY data_evento DESC, id_evento DESC";
