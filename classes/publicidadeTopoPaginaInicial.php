...
//Consulta SQL
    $rs = mysql_query("SELECT * FROM publicidade WHERE (id_localidade = '$localidade' OR id_localidade = 0) AND posicao_publicidade = 1 AND status_publicidade = 1 ORDER BY RAND()");
