...
$inicio = $mat * $pag_views;
	//Consulta SQL
	$sql = "SELECT * FROM noticia WHERE (id_localidade = '$localidade' OR id_localidade = 0) AND id_categoria_noticia = 12 AND posicao_noticia = 2 AND status_noticia = 1 ORDER BY id_noticia DESC";
