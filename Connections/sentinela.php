...
if (!function_exists("anti_invasao")) {
	function anti_invasao($variavel)
	{
	  $retorno = anti_injection(anti_sql_injection($_REQUEST[$variavel]));
	  return $retorno;
	}
}

if (!function_exists("unlinkRecursive")) {
